...
const routes: Routes = [
  ...
  { path: 'view-shopping-item', component: ViewShoppingItemComponent, children: [
      { path: ':id', component: ViewShoppingItemComponent },
      { path: ':id/edit', component: EditShoppingItemComponent },
]},
